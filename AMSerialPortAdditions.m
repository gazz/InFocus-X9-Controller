...
//		[delegate performSelectorOnMainThread:@selector(serialPortReadData:) withObject: waitUntilDone:NO];
		[delegate serialPortReadData:[NSDictionary dictionaryWithObjectsAndKeys: self, @"serialPort", data, @"data", nil]];
	} else {
		[closeLock unlock];
	}
